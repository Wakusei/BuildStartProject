//------------------------------------------------------------------------------
// <copyright file="BuildStartProjectPackage.cs" company="Company">
...
namespace BuildStartProject
{
    ...
    public sealed class BuildStartProjectPackage : AsyncPackage
    {
        ...
        /// </summary>
        public const string PackageGuidString = "329d266a-94df-4e66-a350-32ed008aec8b";

        /// <summary>
        /// Initializes a new instance of the <see cref="BuildStartProject"/> class.
        /// </summary>
        public BuildStartProjectPackage()
        {
